						...
						<Grid.Col width={50}>
							<Grid.Col md={100} lg={50}>
								<Card>
									...
									<Card.Body>
										<h3>Welcome {this.state.user.first_name}.</h3> This is your
										Admin Dashboard. View the latest analytical data and up to
										date information.
									</Card.Body>
								</Card>
							</Grid.Col>
													...
													<Card.Body>
														<VictoryChart>
															<VictoryArea
																...
																labelComponent={
																	<VictoryLabel renderInPortal dy={-20} />
																}
															/>
														</VictoryChart>
													</Card.Body>
										...
										<Grid.Row cards deck>
											...
											<Grid.Col md={6}>
												<Card>
													<Card.Header>
														<Card.Title>
															In Depth Total Passenger Count
														</Card.Title>
													</Card.Header>
													<Card.Body>
														<VictoryChart
