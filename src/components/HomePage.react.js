...
function HomePage() {
  return (
    <SiteWrapper>
      <Page.Content title="Welcome, Hamish Maritz">
        <Grid.Row cards={true}>
          <Grid.Col width={6} sm={4} lg={2}>
            <StatsCard layout={1} movement={6} total="$5.00" label="Account Balance" />
          </Grid.Col>
          <Grid.Col width={6} sm={4} lg={2}>
            <StatsCard
              layout={1}
          ...
          <Grid.Col md={6}>
            ...
            <Grid.Row>
              ...
              <Grid.Col lg={12} md={6}>
              <Card title="Bus Location" body={<GoogleMap blackAndWhite />} /> 
              <Page.MapHeader>
                ...
                bodyItems={[
                  {
                    ...
                    item: [
                      ...
                      { content: "05 April 2019" },
                      {
                        content: (
                          <React.Fragment>
                            <span className="status-icon bg-success" /> SUCCESS
                          </React.Fragment>
                        ),
                      },
                      { content: "$15.00" },
